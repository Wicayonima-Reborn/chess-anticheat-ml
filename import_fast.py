...
def import_fast(zst_file, max_games=500, label="Human", agent_type="RealHuman"):
        ...
        while game_count < max_games:
            ...
            for move in moves:
                moves_log.append({
                    ...
                    "features": [0.0, 0.0, 0.0, 0.0]   # placeholder
                })
                board.push(move)
    ...
    conn.close()
    print(f"✅ {game_count} games imported without features.")

if __name__ == "__main__":
    import_fast("lichess_db_standard_rated_2015-11.pgn.zst", max_games=500)